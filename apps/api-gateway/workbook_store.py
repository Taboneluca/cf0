            ...
            try:
                ...
                try:
                    ...
                    if loop.is_running():
                        ...
                        # Cannot use synchronous database loading here
                        # Create workbook in memory and schedule async load
                        ...
                        async def load_and_update():
                            try:
                                ...
                                if sheet_data and wid in workbooks:
                                    # Update the workbook with loaded data
                                    wb = workbooks[wid]
                                    for sheet_name, data in sheet_data.items():
                                        if sheet_name == "Sheet1" and sheet_name in wb.sheets:
                                ...
                                print(f"Error loading workbook in background: {e}")
                        
                        # Create task but don't await it
                        asyncio.create_task(load_and_update())
                        
                        # Return the empty workbook immediately
